...
namespace PredatorControlApp
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void ApplyRgbModeFromDropdown(int mode)
        {
            ...
            {
                _speedSlider.Enabled = false;
                if (_selectedZone == -1 || (_currentZoneColors[0] == _currentZoneColors[1] && _currentZoneColors[1] == _currentZoneColors[2] && _currentZoneColors[2] == _currentZoneColors[3]))
                {
                    _wmi.SetKeyboardColor(_colorPicker.Color, 0);
                }
                else
                {
