namespace PredatorControlApp
{
    public class GameProfile
    {
        ...
        public int LockWinKey { get; set; } = -1;         // -1: inherit, 0: unlock, 1: lock
        public int LcdOverdrive { get; set; } = -1;       // -1: inherit, 0: off, 1: on
    }
    ...
    public class DashboardSnapshot
    {
        ...
        public bool WasWinKeyLocked { get; set; }
        public bool WasLcdOverdriveEnabled { get; set; }
    }
}
