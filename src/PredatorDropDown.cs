...
namespace PredatorControlApp
{
    ...
    public class PredatorDropDown : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Color bg = _isHover || _isOpen ? theme.CardHover : theme.CardBg;
            Color border = _isHover || _isOpen ? theme.BorderHover : theme.Border;
            ...
            TextRenderer.DrawText(g, displayText, Font, textRect, Color.FromArgb(180, 180, 185),
        ...
        private void ListBox_DrawItem(object? sender, DrawItemEventArgs e)
        {
            ...
            Color bg = isHovered ? theme.CardHover : theme.CardBg;
            Color textCol = isSelected ? theme.Accent : Color.FromArgb(180, 180, 185);
            ...
            if (isSelected)
            {
                ...
                using var checkPen = new Pen(theme.Accent, 1.8f);
