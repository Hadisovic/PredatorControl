...
namespace PredatorControlApp
{
    ...
    public class PredatorSlider : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var brush = new SolidBrush(theme.TrackBg))
            ...
            Color thumbCol = Enabled ? theme.Accent : Color.FromArgb(70, 70, 75);

            if (Enabled)
            {
                using var glowBrush = new SolidBrush(Color.FromArgb(50, theme.Accent.R, theme.Accent.G, theme.Accent.B));
