...
namespace PredatorControlApp
{
    public class PredatorToggle : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Color trackOff = theme.CardBg;
            Color trackOn = Color.FromArgb(
                Math.Min(255, (int)(theme.Accent.R * 0.4f)),
                Math.Min(255, (int)(theme.Accent.G * 0.4f)),
                Math.Min(255, (int)(theme.Accent.B * 0.4f)));
            Color trackDisabled = Color.FromArgb(35, 35, 40);

            Color knobOff = Color.FromArgb(120, 120, 125);
            Color knobOn = theme.Accent;
            ...
            Color borderColor = Enabled
                ? (_isHovered ? theme.BorderHover : theme.Border)
